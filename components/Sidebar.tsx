...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 bg-pastel-teal text-gray-800 h-screen overflow-y-auto shadow-2xl flex flex-col">
            {/* サイドバーヘッダー */}
            <div className="p-6 border-b border-teal-300 shrink-0">
                        ...
                        {pages.map((page, displayedIndex) => {
                            ...
                            return (
                                <li key={page.id} className="group relative">
                                    <button
                                        onClick={() => setCurrentNoteId(page.id)}
